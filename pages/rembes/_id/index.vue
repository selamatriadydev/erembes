            ...
            <div class="p-5">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <p class="text-red-500 text-xs italic" v-if="rembes.rembesproid !== null">
                                <!-- {{ rembes.proyekname }} -->
                                {{ rembes.rembesproid.proyekname }}
                            </p>
                        </div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            <img class="object-fill h-20 w-50" :src="rembes.rembesimageurl">
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="md:flex md:items-center">
                        ...
                        <div class="md:w-2/3">
                            <nuxt-link :to="'/rembes/' + rembes._id + '/update'" class="shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                Update
                            </nuxt-link>
                        </div>
                        <div class="md:w-3/3">
    ...
    methods: {
         deleteRecord(){
            if(confirm("Are you sure?") === true){
                this.$axios.delete('/api/rembes/' + this.$route.params.id)
                .then((response) => {
                    if(response.data._id){
                    this.$router.push({ name:'rembes', params:{ deleted:'yes' } })
                    }
                })
                .catch( (error) => {
                    console.log(error);
