   ...
   <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
       <div class="bg-white border rounded shadow">
            <div class="border-b p-3">
                ...
                <nuxt-link to="/parameter/add" class="bg-green-100 text-green-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-200 dark:text-yellow-900">Tambah</nuxt-link>
            </div>
            <div class="p-5">
...
export default {
    ...
    methods: {
        async fetchGrids(){
            ...
            const {data} = await this.$axios.get('/api/proyek_limit/'+pageNumber)
            this.proyeks = data.proyeks
