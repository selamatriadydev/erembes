...
<div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
       <div class="bg-white border rounded shadow">
            <div class="border-b p-3">
                <h5 class="font-bold uppercase text-gray-600">Update</h5>
            </div>
            <div class="p-5">
...
export default {
    ...
    methods: {
        fillFormData(){
            this.proyekname = this.proyek.proyekname
            this.proyekcode = this.proyek.proyekcode
            this.proyekmember = this.proyek.proyekmember
        },
        submitForm(){
            this.$axios.put( '/api/proyek/' + this.$route.params.id , {
            ...
            if(response.data._id){
                this.$router.push({ name:'parameter-id', params:{ updated:'yes', id: this.$route.params.id } })
            }
            })
            .catch( (error) => {
            console.log(error)
